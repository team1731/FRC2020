...
import org.usfirst.frc.team1731.robot.paths.spacey.Path_E_A;
import org.usfirst.frc.team1731.robot.paths.spacey.Path_E_B;
 ...
 * @see AutoModeBase
 */
public class Mode_E extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing "+this.toString());
    	
    	PathContainer Path = new Path_E_A();
