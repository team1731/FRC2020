...
public class Robot extends TimedRobot {
    ...
    private Drive mDrive = null; //2020 -- not using Drive subsystem!     Drive.getInstance();
    private Climber mClimber = null; //2020 -- TODO FIXME!!! Climber.getInstance();
    private Superstructure mSuperstructure = Superstructure.getInstance();
        ...
        try {
            ...
            { 
                ...
                if (mControlBoard.getTractorDrivePickupHatch()) {
                    ...
                    if  (mDrive != null && aimParams.isPresent() && Math.abs(now - aimParams.get().getLastSeenTimestamp()) < 0.5  ) { 
                        mDrive.setWantTractorBeam();
                    }

                    if (mDrive != null && mDrive.isTBFinished()) {
                        mSuperstructure.openBeak();
                    }
                }
              ...
              //  System.out.println("A");
                if ((mDrive != null && mDrive.isFirstTimeInTractorBeam()) &&   (aimParams.isPresent() && Math.abs(now - aimParams.get().getLastSeenTimestamp()) < 0.5  )) { 
            ...
            else if((climber != 1) && mDrive != null && !mDrive.isDrivingTractorBeam()){
