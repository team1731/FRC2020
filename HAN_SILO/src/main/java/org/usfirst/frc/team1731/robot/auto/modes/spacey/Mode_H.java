...
import org.usfirst.frc.team1731.robot.paths.spacey.Path_H_A;
import org.usfirst.frc.team1731.robot.paths.spacey.Path_H_B;
 ...
 * @see AutoModeBase
 */
public class Mode_H extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing "+this.toString());
    	
    	PathContainer Path = new Path_H_A();
