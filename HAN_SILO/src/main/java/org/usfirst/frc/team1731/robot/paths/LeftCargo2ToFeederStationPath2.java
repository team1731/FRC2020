...
public class LeftCargo2ToFeederStationPath2 extends MirrorablePath implements PathContainer {
    
    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(295, getY(248), 0,   0));
    ...
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(295 , getY(248)), Rotation2d.fromDegrees(getAngle(28))); 
    }
