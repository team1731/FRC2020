package org.usfirst.frc.team1731.lib.util.math;

import static org.usfirst.frc.team1731.lib.util.Util.epsilonEquals;

import java.text.DecimalFormat;

import org.usfirst.frc.team1731.lib.util.Interpolable;
...
public class Rotation2d implements Interpolable<Rotation2d> {
    ...
    public Rotation2d(double cosangle, double sinangle, boolean normalize) {
        cos_angle_ = cosangle;
        sin_angle_ = sinangle;
        if (normalize) {
            normalize();
