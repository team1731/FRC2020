...
import org.usfirst.frc.team1731.robot.paths.spacey.Path_B_A;
import org.usfirst.frc.team1731.robot.paths.spacey.Path_B_B;
 ...
 * @see AutoModeBase
 */
public class Mode_B extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing "+this.toString());
    	
    	PathContainer Path = new Path_B_A();
