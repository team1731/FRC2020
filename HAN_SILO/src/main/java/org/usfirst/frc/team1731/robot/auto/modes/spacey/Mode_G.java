...
import org.usfirst.frc.team1731.robot.paths.spacey.Path_G_A;
import org.usfirst.frc.team1731.robot.paths.spacey.Path_G_B;
 ...
 * @see AutoModeBase
 */
public class Mode_G extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing "+this.toString());
    	
    	PathContainer Path = new Path_G_A();
