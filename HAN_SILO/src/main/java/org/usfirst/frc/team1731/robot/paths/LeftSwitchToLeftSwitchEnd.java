...
public class LeftSwitchToLeftSwitchEnd implements PathContainer {
    
    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(250,237,10,100));
    ...
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(250, 237), Rotation2d.fromDegrees(0)); 
    }
