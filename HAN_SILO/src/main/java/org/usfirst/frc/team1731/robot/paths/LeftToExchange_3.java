...
public class LeftToExchange_3 implements PathContainer {
    
    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(25,192,0,0));
        sWaypoints.add(new Waypoint(60,192,10,80));
        sWaypoints.add(new Waypoint(60,247,0,80));
    ...
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(25, 192), Rotation2d.fromDegrees(180.0)); 
    }
