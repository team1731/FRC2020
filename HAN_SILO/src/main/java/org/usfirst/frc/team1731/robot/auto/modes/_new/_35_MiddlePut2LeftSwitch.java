...
public class _35_MiddlePut2LeftSwitch extends AutoModeBase {

	@Override
	protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing _35_MiddlePut2LeftSwitch");
    	...
    	Path = new MiddleToLeftSwitch_B4();
    	runAction(new DrivePathAction(Path));
    	
    	
    	Path = new MiddleToLeftSwitch_B5();
        runAction(new ParallelAction(Arrays.asList(new Action[] {
        		new ElevatorHome(),
        		new RotateIntakeActionUp(false),
        		new DrivePathAction(Path),
