...
public class LeftToExchange_2 implements PathContainer {
    
    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(120,277,0,0));
        sWaypoints.add(new Waypoint(60,277,10,80));
    ...
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(120, 277), Rotation2d.fromDegrees(0.0)); 
    }
