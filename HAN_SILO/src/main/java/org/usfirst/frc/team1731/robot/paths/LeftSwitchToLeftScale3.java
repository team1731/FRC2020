...
public class LeftSwitchToLeftScale3 implements PathContainer {
    
    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(220,205,0,0));  
        sWaypoints.add(new Waypoint(237,205,10,60));
        sWaypoints.add(new Waypoint(237,242,10,60));
        sWaypoints.add(new Waypoint(249,242,10,60));
        sWaypoints.add(new Waypoint(288,242,0,60));
