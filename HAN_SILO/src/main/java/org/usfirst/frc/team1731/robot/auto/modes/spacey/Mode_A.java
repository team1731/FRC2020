...
import org.usfirst.frc.team1731.robot.paths.spacey.Path_A_A;
import org.usfirst.frc.team1731.robot.paths.spacey.Path_A_B;
 ...
 * @see AutoModeBase
 */
public class Mode_A extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing "+this.toString());
    	
    	PathContainer Path = new Path_A_A();
