 ...
 * @see AutoModeBase
 */
public class RightPutCubeOnRightScaleChamps extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing RightPutCubeOnRightScaleChamps");
    	...
    	Path = new RightSwitchToRightScaleChamps();
        runAction(new ParallelAction(Arrays.asList(new Action[] {
        		new ElevatorUp(), 
        		new RotateIntakeActionUp(),
        		new DrivePathAction(Path)
