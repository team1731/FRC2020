...
import org.usfirst.frc.team1731.robot.paths.spacey.Path_C_A;
import org.usfirst.frc.team1731.robot.paths.spacey.Path_C_B;
 ...
 * @see AutoModeBase
 */
public class Mode_C extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing "+this.toString());
    	
    	PathContainer Path = new Path_C_A();
