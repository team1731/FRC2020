...
public class LeftScaleToRightSwitch implements PathContainer {
    
    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(288,242,0,0));
        sWaypoints.add(new Waypoint(255,242,10,60));
        sWaypoints.add(new Waypoint(255,100,0,30));
        sWaypoints.add(new Waypoint(224,97,10,30));
