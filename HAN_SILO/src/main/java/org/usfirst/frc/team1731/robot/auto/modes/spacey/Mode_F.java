...
import org.usfirst.frc.team1731.robot.paths.spacey.Path_F_A;
import org.usfirst.frc.team1731.robot.paths.spacey.Path_F_B;
 ...
 * @see AutoModeBase
 */
public class Mode_F extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing "+this.toString());
    	
    	PathContainer Path = new Path_F_A();
