...
import org.usfirst.frc.team1731.robot.paths.spacey.Path_I_A;
import org.usfirst.frc.team1731.robot.paths.spacey.Path_I_B;
 ...
 * @see AutoModeBase
 */
public class Mode_I extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing "+this.toString());
    	
    	PathContainer Path = new Path_I_A();
