...
public class LeftToRightScale4 implements PathContainer {
    
    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(19,277,0,0));
        sWaypoints.add(new Waypoint(236,277,10,100));
        sWaypoints.add(new Waypoint(236,177,10,100));
        sWaypoints.add(new Waypoint(236,72,10,100));        
