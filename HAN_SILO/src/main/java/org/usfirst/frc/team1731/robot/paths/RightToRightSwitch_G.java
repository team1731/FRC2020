...
public class RightToRightSwitch_G implements PathContainer {
    
    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(254,38,0,0));
        sWaypoints.add(new Waypoint(254,92,10,60));
    ...
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(254, 38), Rotation2d.fromDegrees(0.0)); 
    }
