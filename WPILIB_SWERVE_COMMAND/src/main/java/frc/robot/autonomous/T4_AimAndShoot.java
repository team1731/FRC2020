...
public class T4_AimAndShoot extends _DelayableStrafingAutoMode {  
    public T4_AimAndShoot(LedStringSubsystem m_ledstring, DriveSubsystem m_robotDrive, SequencerSubsystem m_sequence, ShootClimbSubsystem m_shootclimb, JevoisVisionSubsystem m_vision, TargetingSubsystem m_targeting) {
        ...
        //    new ShootSeqCommand(m_sequence).withTimeout(2));
