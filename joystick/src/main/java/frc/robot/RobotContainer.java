...
public class RobotContainer {
  ...
  Joystick m_operatorController = new Joystick(0);
  //private double joyStickOut;
  ...
  public double getJoystick() {
    return m_operatorController.getRawAxis(6);
  }

  public double getKnob() {
    return m_operatorController.getRawAxis(7);
  }
